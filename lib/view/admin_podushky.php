				...
				<tr style = "vertical-align: top;">
							...
							<div style = "width: 95%; border-right: solid 3px #FFE4B5;">
								...
								<div class = "field_filtre" style = "margin-left: 10px; width: 82%; background: #eeeeee;">
									...
									Материал
									 ...
									 <p style = "font-size: 14px;"><input type="checkbox"> Латекс               <br>
																   <input type="checkbox"> С эффектом памяти            <br>
																   <input type="checkbox"> С гелем         <br>
																   <input type="checkbox"> Пух/Перо                	<br>
																   <input type="checkbox"> Искусственное волокно               
									 </p>
								</div>
								<br>
					...
					<td width = "780px">
						...
						<center>
							<input type = "button" value = "Добавить товар" onclick = "load_img_podu()">
						</center>
						...
						<table cellspacing = "10px" width = "660px">                       <!--таблица товаров-->
							...
							<?php
								...
								require_once dirname(__FILE__).'/../model/read_base_podushky_admin.php';
