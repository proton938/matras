...
<center>
		...
		<p class = "expanation"><strong>Загрузить наматрасник</strong></p>
		...
		<p class = "expanation"><strong>Функция</strong></p>
		<select name = "funct" id = "funct" class = "name_logo">
			<option selected="selected" ></option>
			<option>Защищает</option>
			<option>Увеличивает жесткость</option>
			<option>Уменьшает жесткость</option>
		</select>
		...
		<p class = "expanation"><strong>Толщина</strong></p>
		<input name = "thickness" id = "thickness" type = "text" cols = "10"  class = "name_logo" onclick = "this.value = ''" />
		...
		<input type = "submit" value = "ДОБАВИТЬ" class = "button_enter" name = "reg" action = "" />
