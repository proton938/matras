...
if (isset($_POST['show_matras']))
	{

		echo '<div position: absolute; width: 100px; height: 100px; background: red; >h54yhfgdshtytrw </div>';
	}
...
foreach ($readbuf as $mass)
	{
		...
		if ($j == 1)
			...
			else                                          // если пустая - выводим изображение по умолчанию
				{
